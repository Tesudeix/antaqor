  ...
  if (inline) {
    return (
      <div className="hidden items-center gap-2 md:flex">
        ...
        <span className="text-sm tracking-[2px] text-[#FFFF01]">
        ...
        <div className="h-[2px] w-16 overflow-hidden bg-[#1c1c1c]">
          <div
            className="h-full bg-[#FFFF01] transition-all duration-1000"
            style={{ width: `${pct}%` }}
          />
        </div>
      </div>
  ...
  return (
    <div className="mt-10 w-full max-w-xl">
      <div className="mb-3 flex items-end justify-between">
        <div>
          ...
          <div className="mt-1 text-[clamp(14px,2vw,18px)] tracking-[3px] text-[#ede8df]">
            <span className="text-[#FFFF01]">10,000</span> AI Байлдан дагуулагч бэлтгэх
          </div>
        </div>
        <div className="text-right">
          <div className="text-[clamp(32px,5vw,52px)] leading-none tracking-[-1px] text-[#FFFF01]">
            <AnimatedNumber value={conquerors} />
          </div>
      ...
      <div className="relative h-[3px] w-full overflow-hidden bg-[#1c1c1c]">
        <div
          className="h-full bg-[#FFFF01] transition-all duration-1000 ease-out"
          style={{ width: `${pct}%` }}
        />
        <div
      ...
      {remaining > 0 && (
        <div className="mt-4 flex items-center gap-2">
          ...
          <Link
            href="/auth/signup"
            className="text-[9px] uppercase tracking-[3px] text-[#FFFF01] transition hover:text-[#B3B300]"
          >
            Тэдний нэг бол →
          </Link>
        </div>
