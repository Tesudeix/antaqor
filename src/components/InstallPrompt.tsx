...
export default function InstallPrompt() {
  ...
  return (
    <div className="fixed inset-0 z-[300] flex items-end sm:items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-[380px] mx-4 mb-4 sm:mb-0 animate-[slideUp_0.3s_ease-out] rounded-[4px] bg-[#141414] border border-[rgba(255,255,255,0.08)] overflow-hidden">
        {/* Header accent */}
        ...
        <div className="px-6 pt-6 pb-5">
          ...
          <div className="flex items-center gap-3 mb-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-[4px] bg-[#0A0A0A] border border-[rgba(255,255,255,0.08)]">
              <span className="text-[20px] font-black text-[#EF2C58]">A</span>
            </div>
            <div>
              <h2 className="text-[16px] font-bold text-[#E8E8E8]">Antaqor</h2>
              <p className="text-[11px] text-[#999999]">antaqor.com</p>
            </div>
          </div>

          {/* Description */}
          <p className="text-[13px] leading-[1.6] text-[#999999] mb-5">
            Antaqor аппыг суулгаад илүү хурдан, офлайн горимтой ашиглаарай.
          </p>

          {/* iOS instructions */}
          {isiOS && (
            <div className="mb-5 rounded-[4px] bg-[#0A0A0A] border border-[rgba(255,255,255,0.08)] p-4">
              <p className="text-[12px] font-bold text-[#E8E8E8] mb-3">Апп суулгах:</p>
              <div className="space-y-2.5">
                <div className="flex items-center gap-2.5 text-[12px] text-[#999999]">
                ...
                <div className="flex items-center gap-2.5 text-[12px] text-[#999999]">
                  ...
                  <span><span className="font-semibold text-[#E8E8E8]">Share</span> дарна</span>
                  <svg className="h-4 w-4 shrink-0 text-[#EF2C58]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-center gap-2.5 text-[12px] text-[#999999]">
                  ...
                  <span>Доош гүйлгээд <span className="font-semibold text-[#E8E8E8]">Add to Home Screen</span> дарна</span>
                </div>
                <div className="flex items-center gap-2.5 text-[12px] text-[#999999]">
                  ...
                  <span>Баруун дээд <span className="font-semibold text-[#E8E8E8]">Add</span> дарна</span>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="space-y-2">
            ...
            {!isiOS && !deferredPrompt && (
              <div className="rounded-[4px] bg-[#0A0A0A] border border-[rgba(255,255,255,0.08)] p-4">
                <p className="text-[12px] font-bold text-[#E8E8E8] mb-3">Апп суулгах:</p>
                <div className="space-y-2.5">
                  <div className="flex items-center gap-2.5 text-[12px] text-[#999999]">
                    <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[rgba(239,44,88,0.12)] text-[10px] font-bold text-[#EF2C58]">1</span>
                    <span>Хөтчийн <span className="font-semibold text-[#E8E8E8]">⋮</span> цэс дарна</span>
                  </div>
                  <div className="flex items-center gap-2.5 text-[12px] text-[#999999]">
                    <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[rgba(239,44,88,0.12)] text-[10px] font-bold text-[#EF2C58]">2</span>
                    <span><span className="font-semibold text-[#E8E8E8]">Share</span> дарна</span>
                  ...
                  <div className="flex items-center gap-2.5 text-[12px] text-[#999999]">
                    <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[rgba(239,44,88,0.12)] text-[10px] font-bold text-[#EF2C58]">4</span>
                    <span><span className="font-semibold text-[#E8E8E8]">Add</span> дарна</span>
                  </div>
                </div>
              </div>
            )}
            ...
            <button
              onClick={handleDismiss}
              className="w-full rounded-[4px] border border-[rgba(255,255,255,0.08)] bg-transparent py-2.5 text-[13px] font-medium text-[#999999] transition hover:text-[#E8E8E8] hover:border-[rgba(255,255,255,0.15)]"
            >
              Дараа
            </button>
          </div>
          ...
          <button
            ...
            className="mt-3 w-full text-center text-[11px] text-[#999999] transition hover:text-[#999999]"
          >
            Дахиж бүү харуул
          </button>
        </div>
