    ...
    <div className="fixed bottom-20 left-4 right-4 z-[60] md:bottom-6 md:left-auto md:right-6 md:w-[360px]">
      <div className="border border-[#1c1c1c] bg-[#0f0f0f] p-4 shadow-2xl">
        <div className="flex items-start gap-3">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center bg-[#030303] text-xl font-black text-[#FF6A00]">
            A
          </div>
          <div className="flex-1">
            ...
            <div className="mt-3 flex gap-2">
              <button onClick={handleInstall} className="bg-[#FF6A00] px-4 py-2 text-[10px] font-bold uppercase tracking-[2px] text-[#ede8df] transition hover:bg-[#e8440f]">
                Суулгах
              </button>
