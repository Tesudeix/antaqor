...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-[rgba(0,0,0,0.08)] bg-[rgba(248,248,246,0.92)] backdrop-blur-xl">
      <div className="flex items-center justify-between px-4 py-3 sm:px-6 md:px-8 lg:px-12">
        ...
        <div className="hidden items-center rounded-[4px] border border-[rgba(0,0,0,0.08)] bg-[#FFFFFF] p-1 md:flex">
          {tabs.map((tab) => {
          ...
          {session ? (
            <>
              ...
              <Link
                ...
                className="flex h-8 w-8 items-center justify-center rounded-full border border-[rgba(0,0,0,0.08)] bg-[#FFFFFF] text-[12px] font-bold text-[#EF2C58] transition-all duration-200 hover:border-[rgba(239,44,88,0.4)] hover:shadow-[0_0_16px_rgba(239,44,88,0.1)] overflow-hidden"
              >
                {session.user?.image ? (
            ...
            <>
              <Link
                href="/auth/signin"
                className="text-[13px] font-medium text-[#888888] transition-colors duration-200 hover:text-[#1A1A1A]"
              >
                Нэвтрэх
              </Link>
              <Link
                href="/auth/signup"
                className="rounded-[4px] bg-[#EF2C58] px-5 py-2 text-[12px] font-bold text-[#F8F8F6] transition-all duration-200 hover:shadow-[0_0_24px_rgba(239,44,88,0.25)]"
              >
                Бүртгүүлэх
              </Link>
            </>
