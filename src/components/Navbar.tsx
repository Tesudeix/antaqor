...
function NavTicker() {
  ...
  return (
    <div className="hidden items-center gap-2.5 md:flex">
      <div className="h-3 w-[1px] bg-[#1a1a2e]" />
...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-[rgba(0,240,255,0.08)] bg-[rgba(5,5,10,0.85)] backdrop-blur-md">
      ...
      <div className="flex items-center justify-center gap-2 border-t border-[rgba(0,240,255,0.04)] py-1.5 md:hidden">
        <MobileTicker />
      </div>

      {/* Mobile menu */}
      {menuOpen && (
        <div className="border-t border-[rgba(0,240,255,0.06)] bg-[#0A0B12] px-6 py-5 md:hidden">
