      ...
      <article className="card relative overflow-hidden">
        ...
        <div className="relative px-5 py-6 md:px-6">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-[rgba(3,3,3,0.6)]">
            <svg className="mb-2 h-5 w-5 text-[#006491]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
            </svg>
            <span className="text-[10px] uppercase tracking-[2px] text-[#006491]">Гишүүдэд зориулсан</span>
    ...
    <article className="card overflow-hidden">
      <div className="flex items-center justify-between px-5 pt-5 md:px-6 md:pt-6">
        ...
        <div className="flex items-center gap-2">
          ...
          {canDelete && (
            <button onClick={handleDelete} className="text-[#5a5550] transition hover:text-[#006491]" title="Пост устгах">
      ...
      <div className="flex items-center gap-6 border-t border-[rgba(240,236,227,0.06)] px-5 py-4 md:px-6">
        <button
          ...
          className={`flex items-center gap-2 text-[11px] tracking-[2px] transition ${
            liked ? "font-bold text-[#006491]" : "text-[#5a5550] hover:text-[#006491]"
          }`}
        >
