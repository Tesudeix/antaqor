    ...
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold tracking-[2px] md:text-3xl">
          STORY <span className="text-[#FFD300]">MANAGER</span>
        </h1>
      ...
      <div className="card p-6">
        <div className="mb-4 text-[10px] uppercase tracking-[2px] text-[#FFD300]">
            ...
            {stories.map((story) => (
              <div key={story._id} className="card p-5">
                ...
                <div className="mt-3 flex gap-2 border-t border-[#1a1a2e] pt-3">
                  ...
                  <button onClick={() => handleTogglePublish(story)} className="text-[9px] uppercase tracking-[1px] text-[#5a5550] hover:text-[#FFD300] transition">
