  ...
  return (
    <div className="space-y-6">
      ...
      {showForm && (
        <div className="rounded-[4px] border border-[#1c1c1c] bg-[#111] p-5 space-y-3">
          ...
          <div className="flex items-center gap-2 pt-1">
            ...
            <button
              onClick={resetForm}
              className="rounded-[4px] border border-[#1c1c1c] px-4 py-2.5 text-[12px] text-[#5a5550] transition hover:text-[#c8c8c0]"
            >
              Болих
            </button>
          </div>
      ...
      <div className="space-y-2">
            ...
            <div key={s._id} className="flex items-center gap-4 rounded-[4px] border border-[#1c1c1c] bg-[#111] p-4">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className={`text-[10px] font-bold ${statusInfo?.color || "text-[#5a5550]"}`}>
                    {statusInfo?.label}
                  </span>
                </div>
                <div className="flex items-center gap-2 mt-0.5">
                  <span className="text-[11px] text-[#5a5550]">{s.category}</span>
                  {s.domain && <span className="text-[11px] text-[#3a3835]">· {s.domain}</span>}
                  <span className="text-[10px] text-[#3a3835]">order: {s.order}</span>
                </div>
              </div>
              ...
              <div className="flex shrink-0 gap-2">
                ...
                <button
                  ...
                  className="rounded-[4px] border border-[#1c1c1c] px-3 py-1.5 text-[11px] text-red-400 transition hover:border-red-900/50"
                >
                  Устгах
                </button>
              </div>
        ...
        {services.length === 0 && (
          <p className="py-10 text-center text-[13px] text-[#5a5550]">Үйлчилгээ бүртгэгдээгүй</p>
        )}
      </div>
    </div>
  );
