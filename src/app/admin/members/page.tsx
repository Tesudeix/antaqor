    ...
    <div>
      ...
      {message && (
        <div className="mb-6 border-l-2 border-[#FFFF01] bg-[rgba(0,100,145,0.08)] px-4 py-3 text-[12px] text-[#FFFF01]">
          {message}
          <button onClick={() => setMessage("")} className="ml-3 text-[10px] text-[#5a5550] hover:text-[#FFFF01]">
            ✕
          </button>
        </div>
      )}
      ...
      <div className="mb-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <div className="card p-4">
          ...
          <div className="mt-1 text-2xl tracking-[2px] text-[#FFFF01]">{totalMembers}</div>
        </div>
        <div className="card p-4">
      ...
      <div className="mb-8 grid gap-3 sm:grid-cols-2">
        <div className="card p-4">
          <div className="mb-3 text-[10px] uppercase tracking-[0.5px] text-[#FFFF01]">AI Түвшин</div>
        ...
        <div className="card p-4">
          <div className="mb-3 text-[10px] uppercase tracking-[0.5px] text-[#FFFF01]">Түгээмэл сонирхол</div>
          ...
          {[
            ...
            <button
              ...
              className={`px-3 py-2 text-[9px] uppercase tracking-[2px] transition ${
                filter === f.value
                  ? "bg-[rgba(0,100,145,0.1)] text-[#FFFF01]"
              ...
              <div key={user._id} className="card">
                ...
                >
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {member ? (
                      <span className="px-2 py-1 text-[9px] uppercase tracking-[2px] bg-[rgba(0,100,145,0.1)] text-[#FFFF01]">
                        Гишүүн
                    ...
                    {!member ? (
                      <button
                        ...
                        className="px-3 py-1.5 text-[9px] uppercase tracking-[2px] bg-[#FFFF01] text-[#ede8df] transition hover:bg-[#B3B300] disabled:opacity-50"
                      >
                      ...
                      <>
                        <button
                          onClick={(e) => { e.stopPropagation(); setGrantModal(user); setGrantDays(30); }}
                          disabled={actionLoading === user._id}
                          className="px-3 py-1.5 text-[9px] uppercase tracking-[2px] text-[#5a5550] transition hover:text-[#FFFF01] disabled:opacity-50"
                        >
                          Сунгах
                        </button>
                        <button
