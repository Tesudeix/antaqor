...
const NAV_ITEMS = [
  ...
  { href: "/admin/threads", label: "Posts", icon: "M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" },
  { href: "/admin/threads/replies", label: "Replies", icon: "M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z" },
];

const ADMIN_USERNAME = "antaqor";
...
export default function AdminLayout({ children }: { children: ReactNode }) {
  ...
  const isAdmin =
    session?.user?.name?.toLowerCase() === ADMIN_USERNAME.toLowerCase();
