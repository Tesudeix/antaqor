      ...
      html: `
        <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; background: #0f0f0f; color: #ede8df; padding: 40px; border: 1px solid #1c1c1c;">
          <div style="font-size: 24px; font-weight: bold; letter-spacing: 4px; margin-bottom: 24px;">
            ANTA<span style="color: #FFD300;">QOR</span>
          </div>
          ...
          <a href="${resetUrl}" style="display: inline-block; background: #FFD300; color: #ede8df; padding: 12px 32px; font-size: 12px; font-weight: 600; letter-spacing: 1px; text-transform: uppercase; text-decoration: none;">
            Нууц үг сэргээх
          </a>
