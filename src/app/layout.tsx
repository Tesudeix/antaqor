  ...
  return (
    <html lang="mn">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Commissioner:wght@300;400;500;600;700;800;900&family=Orbitron:wght@400;500;600;700;800;900&family=Rajdhani:wght@300;400;500;600;700&family=Share+Tech+Mono&display=swap"
          rel="stylesheet"
        />
          ...
          <footer className="relative z-[1] mb-16 border-t border-[rgba(0,240,255,0.08)] bg-[#05050A] md:mb-0">
            ...
            <div className="border-b border-[rgba(0,240,255,0.05)] px-6 py-10 md:px-10">
              <div className="mx-auto grid max-w-5xl gap-6 sm:grid-cols-2 lg:grid-cols-4">
                <div>
                  <div className="mb-2 font-[Orbitron] text-sm font-bold tracking-[2px] text-[#ede8df]">ФУТУРИЗМ</div>
                ...
                <div>
                  <div className="mb-2 font-[Orbitron] text-sm font-bold tracking-[2px] text-[#ede8df]">ЦАГ ХУГАЦАА</div>
                  <p className="text-[11px] leading-[1.8] text-[rgba(240,236,227,0.35)]">
                    Шийдвэр бүр үр ашгаар шүүгдэнэ. Илүү хурдан, илүү хөнгөн.
                  </p>
                </div>
                <div>
                  <div className="mb-2 font-[Orbitron] text-sm font-bold tracking-[2px] text-[#ede8df]">ДАСАН ЗОХИЦОЛ</div>
                  <p className="text-[11px] leading-[1.8] text-[rgba(240,236,227,0.35)]">
                    Өөрчлөлтөд дасахгүй — урьдчил. Хөгжихөө хэзээ ч бүү зогсоо.
                  </p>
                </div>
                <div>
                  <div className="mb-2 font-[Orbitron] text-sm font-bold tracking-[2px] text-[#FF6A00]">МӨНХИЙН БАЙЛДАН ДАГУУЛАЛТ</div>
                  <p className="text-[11px] leading-[1.8] text-[rgba(240,236,227,0.35)]">
              ...
              <div className="mx-auto max-w-5xl">
                <div className="flex flex-col gap-8 md:flex-row md:justify-between">
                  ...
                  <div className="max-w-xs">
                    <div className="font-[Orbitron] text-xl font-bold tracking-[4px]">
                  ...
                  <div className="flex gap-12">
                    <div>
                      ...
                      <div className="flex flex-col gap-2">
                        <a href="/members" className="text-[11px] text-[rgba(240,236,227,0.4)] transition hover:text-[#FF6A00]">Гишүүд</a>
                        <a href="/classroom" className="text-[11px] text-[rgba(240,236,227,0.4)] transition hover:text-[#FF6A00]">Хичээл</a>
                        <a href="/clan" className="text-[11px] text-[rgba(240,236,227,0.4)] transition hover:text-[#FF6A00]">Клан</a>
                      </div>
                    </div>
                    <div>
                      <div className="mb-3 text-[9px] uppercase tracking-[2px] text-[#00F0FF]">Холбоос</div>
                      <div className="flex flex-col gap-2">
                        <a href="https://www.threads.net/@antaqor" target="_blank" rel="noopener noreferrer" className="text-[11px] text-[rgba(240,236,227,0.4)] transition hover:text-[#FF6A00]">Threads</a>
                        <a href="https://www.facebook.com/antaqor" target="_blank" rel="noopener noreferrer" className="text-[11px] text-[rgba(240,236,227,0.4)] transition hover:text-[#FF6A00]">Facebook</a>
                        <a href="https://www.youtube.com/@antaqor" target="_blank" rel="noopener noreferrer" className="text-[11px] text-[rgba(240,236,227,0.4)] transition hover:text-[#FF6A00]">YouTube</a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <a href="https://www.threads.net/@antaqor" target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center border border-[rgba(0,240,255,0.15)] text-[rgba(240,236,227,0.4)] transition-all hover:border-[#FF6A00] hover:text-[#FF6A00] hover:shadow-[0_0_10px_rgba(255,106,0,0.3)]">
                      ...
                      <a href="https://www.facebook.com/antaqor" target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center border border-[rgba(0,240,255,0.15)] text-[rgba(240,236,227,0.4)] transition-all hover:border-[#FF6A00] hover:text-[#FF6A00] hover:shadow-[0_0_10px_rgba(255,106,0,0.3)]">
                        <svg viewBox="0 0 24 24" fill="currentColor" className="h-3.5 w-3.5">
                          <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                        </svg>
                      </a>
                      <a href="https://www.youtube.com/@antaqor" target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center border border-[rgba(0,240,255,0.15)] text-[rgba(240,236,227,0.4)] transition-all hover:border-[#FF6A00] hover:text-[#FF6A00] hover:shadow-[0_0_10px_rgba(255,106,0,0.3)]">
                        <svg viewBox="0 0 24 24" fill="currentColor" className="h-3.5 w-3.5">
