                ...
                <div className="flex flex-col gap-8 md:flex-row md:justify-between">
                  ...
                  <div className="flex gap-12">
                    ...
                    <div>
                      ...
                      <div className="flex flex-col gap-2">
                        <a href="https://www.instagram.com/antaqor" target="_blank" rel="noopener noreferrer" className="text-[11px] text-[rgba(240,236,227,0.4)] transition hover:text-[#006491]">Instagram</a>
                        <a href="https://www.threads.net/@antaqor" target="_blank" rel="noopener noreferrer" className="text-[11px] text-[rgba(240,236,227,0.4)] transition hover:text-[#006491]">Threads</a>
                        <a href="https://www.facebook.com/antaqor" target="_blank" rel="noopener noreferrer" className="text-[11px] text-[rgba(240,236,227,0.4)] transition hover:text-[#006491]">Facebook</a>
                        <a href="https://www.youtube.com/@antaqor" target="_blank" rel="noopener noreferrer" className="text-[11px] text-[rgba(240,236,227,0.4)] transition hover:text-[#006491]">YouTube</a>
                        <a href="https://www.tiktok.com/@antaqor" target="_blank" rel="noopener noreferrer" className="text-[11px] text-[rgba(240,236,227,0.4)] transition hover:text-[#006491]">TikTok</a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      {/* Instagram */}
                      <a href="https://www.instagram.com/antaqor" target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center border border-[rgba(0,240,255,0.15)] text-[rgba(240,236,227,0.4)] transition-all hover:border-[#006491] hover:text-[#006491] hover:shadow-[0_0_10px_rgba(0,100,145,0.3)]">
                      ...
                      {/* Threads */}
                      <a href="https://www.threads.net/@antaqor" target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center border border-[rgba(0,240,255,0.15)] text-[rgba(240,236,227,0.4)] transition-all hover:border-[#006491] hover:text-[#006491] hover:shadow-[0_0_10px_rgba(0,100,145,0.3)]">
                        <svg viewBox="0 0 24 24" fill="currentColor" className="h-3.5 w-3.5">
                      ...
                      {/* Facebook */}
                      <a href="https://www.facebook.com/antaqor" target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center border border-[rgba(0,240,255,0.15)] text-[rgba(240,236,227,0.4)] transition-all hover:border-[#006491] hover:text-[#006491] hover:shadow-[0_0_10px_rgba(0,100,145,0.3)]">
                        <svg viewBox="0 0 24 24" fill="currentColor" className="h-3.5 w-3.5">
                          <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                        </svg>
                      </a>
                      {/* YouTube */}
                      <a href="https://www.youtube.com/@antaqor" target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center border border-[rgba(0,240,255,0.15)] text-[rgba(240,236,227,0.4)] transition-all hover:border-[#006491] hover:text-[#006491] hover:shadow-[0_0_10px_rgba(0,100,145,0.3)]">
                        <svg viewBox="0 0 24 24" fill="currentColor" className="h-3.5 w-3.5">
                          <path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                        </svg>
                      </a>
                      {/* TikTok */}
                      <a href="https://www.tiktok.com/@antaqor" target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center border border-[rgba(0,240,255,0.15)] text-[rgba(240,236,227,0.4)] transition-all hover:border-[#006491] hover:text-[#006491] hover:shadow-[0_0_10px_rgba(0,100,145,0.3)]">
                        <svg viewBox="0 0 24 24" fill="currentColor" className="h-3.5 w-3.5">
