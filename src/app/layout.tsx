          ...
          <footer className="relative z-[1] border-t border-[rgba(240,236,227,0.08)] bg-[#030303] px-6 py-12 md:px-10">
            <div className="mx-auto flex max-w-5xl flex-col items-center gap-6 md:flex-row md:justify-between">
              ...
              <div className="flex gap-3">
                <a href="https://www.threads.com/@antaqor" target="_blank" className="flex h-10 w-10 items-center justify-center border border-[rgba(240,236,227,0.1)] text-[rgba(240,236,227,0.4)] transition-all hover:border-[#cc2200] hover:text-[#ede8df]">
                ...
                <a href="https://www.facebook.com/profile.php?id=61582691680480" target="_blank" className="flex h-10 w-10 items-center justify-center border border-[rgba(240,236,227,0.1)] text-[rgba(240,236,227,0.4)] transition-all hover:border-[#cc2200] hover:text-[#ede8df]">
                  <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </a>
                <a href="https://www.youtube.com/@Antaqorx" target="_blank" className="flex h-10 w-10 items-center justify-center border border-[rgba(240,236,227,0.1)] text-[rgba(240,236,227,0.4)] transition-all hover:border-[#cc2200] hover:text-[#ede8df]">
                  <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
