...
const secondaryColors = [
  { name: "Steel", hex: "#141418", text: "#9E9EA8" },
  { name: "Iron", hex: "#1E1E24", text: "#9E9EA8" },
  { name: "Gold Light", hex: "#D9AB55", text: "#4A3520" },
  { name: "Gold Dark", hex: "#A67C2E", text: "#E8E5DF" },
...
function SectionHeader({ num, eyebrow, title }: { num: string; eyebrow: string; title: string }) {
  return (
    <div className="relative mb-8">
      ...
      <h2 className="text-[22px] font-normal leading-snug text-[#F5F3EF] md:text-[28px]">
        {title}
      </h2>
    </div>
  );
  ...
  return (
    <div className="py-6">
      ...
      <div className="relative mb-16 flex flex-col items-center overflow-hidden rounded-[4px] border border-[#1a1a22] bg-[#0c0c10] px-6 py-16 text-center md:py-24">
        ...
        <h1 className="text-[clamp(40px,10vw,72px)] font-bold uppercase leading-[0.92] tracking-[0.12em] text-[#F5F3EF]"
        ...
        <p className="mt-6 text-[clamp(14px,2vw,18px)] italic text-[#9E9EA8]"
      ...
      <section className="mb-4">
        ...
        <p className="mb-8 text-[14px] font-light leading-[1.9] text-[#9E9EA8]">
      ...
      <section className="mb-4">
        ...
        <p className="mb-6 text-[14px] font-light leading-[1.9] text-[#9E9EA8]">
