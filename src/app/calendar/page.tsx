...
const TYPE_CONFIG: Record<string, { label: string; color: string; bg: string; iconPath: string }> = {
  ...
  class:     { label: "Хичээл",     color: "#0F81CA", bg: "rgba(15,129,202,0.18)", iconPath: "M4.26 10.147a60.438 60.438 0 00-.491 6.347A48.62 48.62 0 0112 20.904a48.62 48.62 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.636 50.636 0 00-2.658-.813A59.906 59.906 0 0112 3.493a59.903 59.903 0 0110.399 5.84" },
