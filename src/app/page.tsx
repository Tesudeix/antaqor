...
function HeroLanding() {
  return (
    <div className="flex min-h-[80vh] flex-col items-center justify-center px-5 text-center">
      {/* Logo */}
      <div className="mb-6">
        <h1 className="text-[48px] font-bold tracking-[6px] text-[#e8e6e1] sm:text-[56px]">
          ANTA<span className="text-[#FFD300]">QOR</span>
        </h1>
        <p className="mt-1 text-[11px] tracking-[4px] text-[#5a5550]">
          ДИЖИТАЛ ҮНДЭСТЭН
        </p>
      </div>

      {/* Description */}
      <p className="mb-6 max-w-xs text-[13px] leading-relaxed text-[#6b6b78]">
      ...
      <Link
        href="/auth/signup"
        className="rounded-[4px] bg-[#FFD300] px-8 py-3 text-[14px] font-bold text-black transition hover:bg-[#e6be00] active:scale-[0.98]"
      >
        Кланд нэгдэх
      </Link>
      ...
      <div className="mt-8 flex items-center gap-5">
        ...
        <a href="https://www.youtube.com/@antaqor" target="_blank" rel="noopener noreferrer" className="text-[#5a5550] transition hover:text-[#FFD300]" aria-label="YouTube">
          <svg className="h-[18px] w-[18px]" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
        </a>
      ...
      {/* Already a member */}
      <p className="mt-6 text-[12px] text-[#5a5550]">
        Гишүүн үү?{" "}
    ...
    <div className="-mx-5">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-[#1a1a22]">
        ...
        <div className="flex items-center gap-2 pr-1">
          <Link href="/posts/new" className="rounded-[4px] bg-[#FFD300] px-4 py-1.5 text-[12px] font-semibold text-black transition hover:bg-[#e6be00]">
            + Пост
          </Link>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="py-20 text-center">
          ...
          <Link href="/posts/new" className="mt-6 inline-block rounded-[4px] bg-[#FFD300] px-5 py-2 text-[13px] font-semibold text-black transition hover:bg-[#e6be00]">
            Пост үүсгэх
          </Link>
        </div>
      ) : (
