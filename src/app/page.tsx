...
const SOCIALS = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/tesudei",
    icon: (
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/tesudei",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/@tesudei",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
  ...
  {
    name: "Threads",
    href: "https://www.threads.net/@tesudei",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@tesudei",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
        ...
        <div className="social-slider flex w-max gap-10 px-6">
          {[...SOCIALS, ...SOCIALS].map((s, i) => (
            ...
            >
              ...
              <span className="text-[11px] tracking-[1px]">@tesudei</span>
