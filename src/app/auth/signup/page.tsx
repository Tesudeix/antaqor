      ...
      <div className="w-full max-w-md">
        <div className="card p-8 md:p-10">
          ...
          <p className="mb-8 text-[11px] tracking-[2px] text-[#5a5550]">
            BECOME PART OF THE DIGITAL NATION
          </p>
          ...
          <div className="mb-6 flex items-center gap-4">
            ...
            <span className="text-[10px] tracking-[3px] text-[#5a5550]">OR</span>
            <div className="h-px flex-1 bg-[#1c1c1c]" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="••••••••"
              />
              <p className="mt-1 text-[10px] text-[#5a5550]">At least 6 characters</p>
            </div>
