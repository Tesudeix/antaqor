...
const STATUS_COLORS: Record<string, string> = {
  ...
  accepted: "text-[#FFD300] border-[#FFD300]",
        ...
        <div>
          {showCreate ? (
            ...
            <button
              ...
              className="w-full border border-dashed border-[#2a2825] px-4 py-3 text-[10px] uppercase tracking-[2px] text-[#5a5550] transition hover:border-[#FFD300] hover:text-[#FFD300]"
            >
              + Даалгавар үүсгэх
            </button>
          )}
            ...
            {openTasks.map((task) => (
              <div key={task._id} className="card p-5">
                ...
                <div className="mt-3 flex items-center gap-2">
                  ...
                  {admin && (
                    <button onClick={() => handleDelete(task._id)} className="btn-ghost !py-1.5 !px-4 !text-[9px] !text-[#FFD300]">
                      Устгах
                    </button>
                  )}
                </div>
