  ...
  if (loading) {
    return (
      <div className="flex min-h-[60vh] items-center justify-center">
        <div className="h-[2px] w-8 animate-pulse bg-[#FFFF01]" />
      </div>
    );
  }
    ...
    <div>
      ...
      <section className="relative py-20 md:py-28">
        ...
        <h1 className="text-[clamp(48px,9vw,120px)] leading-[0.85] tracking-[-2px]">
          <span className="text-[#FFFF01]">VPN</span><br />
      ...
      <section className="mb-20">
        <div className="border border-[#1c1c1c]">
          {/* Header */}
          <div className="border-b border-[#1c1c1c] bg-[#FFFF01] px-8 py-8 md:px-12">
