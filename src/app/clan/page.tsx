      ...
      <div className="mx-auto max-w-md py-4">
        <AnimatePresence mode="wait">
          {status === "paid" ? (
            ...
            >
              <div className="mb-5 flex h-16 w-16 items-center justify-center rounded-full bg-[#EF2C58] shadow-[0_0_40px_rgba(239,44,88,0.3)]">
              ...
              <div className="mt-6 flex gap-3">
                <Link href="/classroom" className="rounded-[4px] bg-[#EF2C58] px-5 py-2.5 text-[13px] font-bold text-white">Хичээл</Link>
                <Link href="/" className="rounded-[4px] border border-[rgba(255,255,255,0.08)] px-5 py-2.5 text-[13px] font-bold text-[#AAA]">Feed</Link>
              </div>
            </motion.div>
          ) : status === "failed" ? (
            <motion.div key="failed" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="rounded-[4px] border border-[rgba(239,68,68,0.25)] bg-[rgba(239,68,68,0.06)] p-5 text-center">
              ...
              <button onClick={() => { setStep("payment"); }} className="mt-4 rounded-[4px] bg-[#EF2C58] px-5 py-2.5 text-[13px] font-bold text-white">Дахин оролдох</button>
            </motion.div>
          ) : (
    ...
    return (
      <div className="mx-auto max-w-md">
          ...
          >
            ...
            <span
              className={`shrink-0 rounded-full px-2.5 py-1 text-[10px] font-black tracking-wider transition ${
                copied === "ref" ? "bg-[#EF2C58] text-white" : "bg-[#EF2C58] text-white group-hover:bg-[#D4264E]"
              }`}
            >
        ...
        <button
          ...
          className="group relative mt-5 flex w-full items-center justify-center gap-2 overflow-hidden rounded-[4px] bg-[#EF2C58] py-4 text-[14px] font-black text-white shadow-[0_0_24px_rgba(239,44,88,0.25)] transition hover:shadow-[0_0_40px_rgba(239,44,88,0.4)]"
        >
  ...
  return (
    <div className="mx-auto max-w-md py-4">
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-[4px] border border-[rgba(239,44,88,0.25)] bg-gradient-to-br from-[rgba(239,44,88,0.08)] via-[#111] to-[#0D0D0D] p-6 md:p-7"
      >
        ...
        {session ? (
          <button
            onClick={handleJoin}
            disabled={submitting}
            className="group relative mt-6 flex w-full items-center justify-center gap-2 overflow-hidden rounded-[4px] bg-[#EF2C58] py-4 text-[14px] font-black text-white shadow-[0_0_24px_rgba(239,44,88,0.25)] transition hover:shadow-[0_0_40px_rgba(239,44,88,0.45)] disabled:opacity-60"
          >
          ...
          <Link
            href="/auth/signup"
            className="group relative mt-6 flex w-full items-center justify-center gap-2 overflow-hidden rounded-[4px] bg-[#EF2C58] py-4 text-[14px] font-black text-white shadow-[0_0_24px_rgba(239,44,88,0.25)] transition hover:shadow-[0_0_40px_rgba(239,44,88,0.45)]"
          >
      ...
      {/* Trust / support */}
      <div className="mt-5 rounded-[4px] border border-[rgba(255,255,255,0.06)] bg-[#0F0F0F] p-4 text-center">
